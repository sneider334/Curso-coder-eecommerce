...
const ItemDetailContainer=()=>{
    ...
    const productos =  [ 
    {id : 'uno', name : 'Termo 2000', price:500, category: 'acero inoxidable', img:"https://www.brandit.com.ar/wp-content/uploads/2017/08/Termo_Acero_InoxidableManija.png", stock: 10, description: "Descripcion de termo 2000"},
    ...
    useEffect(()=>{
        const mockAsync = new Promise((res, rej) =>{
            setTimeout(()=>{
                res(productos.find(prod => prod.id === productos.id));
                rej ("error")
            },2000)
        })
        mockAsync
        ...
        mockAsync.finally(()=>console.log("finished"))
    },[parametros.id])
